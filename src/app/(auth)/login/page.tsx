    ...
    <main className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-melora-surfaceLayer/60 backdrop-blur-[20px] border border-white/5 p-8 md:p-10 rounded-card shadow-soft relative z-10">
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center ml-1">
              <label className="text-sm font-medium text-melora-textSecondary">
                Password
              </label>
              <Link
                href="/forgot-password"
                className="text-xs text-melora-pink hover:text-melora-orange transition-colors duration-base"
              >
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-melora-textSecondary mt-8">
          ...
          <Link
            href="/register"
            className="text-melora-pink font-semibold hover:text-melora-orange transition-colors duration-base"
          >
            Create one
          </Link>
        </p>
