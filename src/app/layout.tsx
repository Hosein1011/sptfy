...
export const metadata: Metadata = {
  ...
  description: "A premium, calm, and immersive next-generation music streaming platform.",
  icons: {
    // This will point to the flowing "M" wave icon once generated
    icon: "/favicon.ico", 
  },
};
    ...
    <html lang="en" className={`${poppins.variable} font-sans`}>
      <body 
        className={`
          ...
          antialiased 
          overflow-x-hidden 
          selection:bg-[#7B5CFF] selection:text-white
