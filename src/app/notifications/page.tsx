...
import { Bell, Check, CheckCircle2, Trash2, BellRing } from "lucide-react";
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      type: "social",
      text: "Alex Mercer started following you.",
      time: "2 mins ago",
      read: false,
    },
    {
      id: 2,
      type: "system",
      text: "Your Gold Tier subscription has been successfully renewed.",
      time: "3 hours ago",
      read: false,
    },
    {
      id: 3,
      type: "music",
      text: "New release from The Weeknd matches your Vibe Profile.",
      time: "Yesterday",
      read: true,
    },
    {
      id: 4,
      type: "social",
      text: "Sarah added 'Midnight City' to their public playlist.",
      time: "2 days ago",
      read: true,
    },
  ]);
        ...
        <div className="flex items-center gap-4">
          <div className="bg-melora-surfaceLayer/50 p-1 rounded-lg border border-white/5 flex">
            <button
              ...
              className={`px-4 py-1.5 text-sm font-semibold rounded-md transition-all duration-base ${activeTab === "all"
            ...
            <button
              ...
              className={`px-4 py-1.5 text-sm font-semibold rounded-md transition-all duration-base ${activeTab === "unread"
                  ? "bg-white/10 text-white"
                  : "text-melora-textMuted hover:text-white"
                }`}
            >
        ...
        {filteredNotifs.length > 0 ? (
          <div className="divide-y divide-white/5">
            {filteredNotifs.map((notif) => (
              ...
              >
                <div
                  className={`mt-1 w-3 h-3 rounded-full flex-shrink-0 ${!notif.read
                      ? "bg-melora-purple shadow-[0_0_12px_rgba(123,92,255,0.8)]"
                ...
                <div className="flex-1">
                  <p
                    className={`text-base md:text-lg mb-1 ${!notif.read
                        ? "text-white font-semibold"
                        : "text-melora-textSecondary"
                      }`}
                  >
                    {notif.text}
                  </p>
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    <span className="text-sm text-melora-textMuted">
                      {notif.time}
                    </span>
                ...
                {!notif.read && (
                  <button
                    ...
                    className="opacity-100 md:opacity-0 md:group-hover:opacity-100 p-2 text-melora-textSecondary hover:text-melora-purple transition-all rounded-md hover:bg-white/5"
                    title="Mark as read"
                  >
          ...
          <div className="p-16 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-melora-textSecondary max-w-md relative z-10">
              You are completely caught up. When someone follows you, updates a
              playlist, or drops new music, it will appear here.
            </p>
